...
const IDCard = ({
  ...
  return (
    <div
      className="w-[600px] h-[410px] relative"
      style={{ backgroundColor: colors.slate800 }}
    >
      <div className="relative w-full h-full">
        ...
        {/* Header solid color biru tua (tanpa gradient) */}
        <div
        ...
        >
          <h1
            className="font-orbitron text-3xl font-bold tracking-widest text-white"
            style={{
              textShadow: `0 2px 4px ${colors.surface}`,
            }}
          >
            SOMNIA FUN CARD
          </h1>
